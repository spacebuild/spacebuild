...
function SWEP:Reload()
	...
	if ( not gamemode.Call( "CanTool", self.Owner, trace, mode ) ) then return end
...
function SWEP:Think()
	...
	if ( self.last_mode ~= self.current_mode ) then
		...
		if ( not self:GetToolObject( self.last_mode ) ) then return end
...
function SWEP:Holster()
	...
	if ( not self:GetToolObject() ) then return self.CanHolster end
