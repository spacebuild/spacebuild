...
local files = {"ls3_energysystems", "ls3_environmental_control", "ls3_other", "ls3_other_ligths", "ls3_receptacles", "pumps", "resourcenodes", "sb_dev_plants", "sb_terraformer", "valves"}
